...
public class Krinsky {
    public static double accuracyy = 0.78;



    //state depth = 3
    //move to the most internal state at reward, penalty is exactly as tsetlin
    ...
    public static double highestStrength = 0.0;
        public static int stateDepth = states/action;
        ...
        public static int Reward(int currentState)
        {
            if(currentState == 1 || currentState%3 == 1) {
                return currentState;
            }
            else if(currentState<=stateDepth) {
                currentState = 1;
        ...
        public static int Krinsky(int stateDepth, int currentState){
        ...
        public static void main(String[] args) {
            ...
            for(int i = 0; i<experiments; i++) {
                ...
                while (iteration < numberOfIterations) {
                    iteration++;
                    currentState = Krinsky(stateDepth, currentState);
                    if (currentState <= stateDepth) {
                        if (iteration > 9900) {
                            a1++;
                            System.out.print("1");
