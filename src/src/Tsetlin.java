...
public class Tsetlin {
    public static double accuracyy = 0.96;


    public static int states = 40;
    ...
    {
        if(currentState == 1 || currentState%5 == 1)
        {
            return currentState;
        }
        else
    ...
    public static int Tsetlin(int stateDepth, int currentState){
    ...
    while (iteration < numberOfIterations) {
        iteration++;
        currentState = Tsetlin(stateDepth, currentState);
        if (currentState <= stateDepth) {
            if (iteration > 9900) {
                a1++;
                System.out.print("1");
        ...
        int accuracy = (a8/(a1+a2+a3+a4+a5+a6+a7+a8));
        System.out.println("\nAction 1: " + a1/100);
        System.out.println("\nAction 2: " + a2/100);
        System.out.println("\nAction 3: " + a3/100);
        System.out.println("\nAction 4: " + a4/100);
